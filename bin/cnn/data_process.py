...
def getTrTxtData(dataFile,delim):
    """
    Prepare the data
    """  
    data=[]
...
def shuffleTrData(dataFile,numInst,delim):
    """
    Prepare the data
    """  
    data=[]
...
def getTokenizer(data,MAX_NB_WORDS,MAX_SEQUENCE_LENGTH):
    """
    Prepare the data
    """  
...
def getTrVector(data,lab,tokenizer,MAX_SEQUENCE_LENGTH):
    le = preprocessing.LabelEncoder()
...
def getTrData(dataFile,MAX_NB_WORDS,MAX_SEQUENCE_LENGTH,delim):
    """
    Prepare the data
    """  
...
def getTrDataLabelEncoder(dataFile,tokenizer,MAX_SEQUENCE_LENGTH,delim):
    """
    Prepare the data
    """      
    data=[]
...
def getDevData(dataFile,tokenizer,MAX_SEQUENCE_LENGTH,delim,train_le):
    """
    Prepare the data
    """      
    data=[]
...
def getDevData2(dataFile,tokenizer,MAX_SEQUENCE_LENGTH,delim):
    """
    Prepare the data
    """
    ids=[]      
    ...
    data = pad_sequences(sequences, maxlen=MAX_SEQUENCE_LENGTH)
    print('Shape of data tensor:', data.shape)
    return data,y,le,labels,ids
    
def getDevDataWithID(dataFile,tokenizer,MAX_SEQUENCE_LENGTH,delim):
    """
    Prepare the data
    """      
    data=[]
...
def prepareEmbedding(word_index,model,MAX_NB_WORDS,EMBEDDING_DIM):
